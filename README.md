...
## # 🤖 Text-to-Image Generator | Internship Proof-of-Concept

### Candidate Submission: [Your Full Name]
**Contact:** intern@talrn.com | [Your Personal Email]
**Joining Date Availability:** [Your Availability Date, e.g., Immediately / Two Weeks Notice]

***

## 1. Project Overview and Architecture

This project implements a powerful **Text-to-Image Generation System** built using **Diffusion Models** via the Hugging Face `diffusers` library, delivered through an interactive **Streamlit** web UI.
...
* ⚡ Runs on low-end hardware using **CPU/GPU offload**
* 🎨 Multiple image styles (Photorealistic, Artistic, Van Gogh, etc.)
* ✍️ **Automatic prompt enhancement** for higher quality images
* 🚫 **Universal Negative Prompt** support (fixed in code)
* 💾 Automatic saving of images (PNG + JPEG) with metadata
* 🏷️ **AI Watermarked** PNG metadata for transparency
* 🔧 Highly optimized model loading with **Streamlit cache**
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/ThangakumarC/Image_gen.git](https://github.com/ThangakumarC/Image_gen.git)
    cd Image_gen
    ```
...
## 3. Hardware Requirements & Implementation Paths
...
## 4. Usage Instructions & Prompt Engineering

### Usage Instructions

The application is run locally using `streamlit run app.py` and accessed via the local browser URL (`http://localhost:8501`).

1.  **Select Style:** Choose one of the preset styles (e.g., *Photorealistic*) from the sidebar dropdown. This triggers the automatic prompt enhancement.
2.  **Enter Base Prompt:** Provide a simple, descriptive subject and scene.
3.  **Set Parameters:** Adjust the **Inference Steps** (25 is recommended) and **Guidance Scale** (7.5 is recommended) in the sidebar and **No.of.Images** you need.
4.  **Generate:** Click **Generate Image(s)**.
...
| Prompt Style | Base Prompt | **Full (Enhanced) Prompt Used** | Image Result |
| :--- | :--- | :--- | :--- |
| **Photorealistic** | A futuristic city at sunset | **A futuristic city at sunset, highly detailed, 4K, professional photography, cinematic lighting, dramatic volumetric light, hyper-realistic, sharp focus** | ![Photorealistic sample image](https://github.com/ThangakumarC/Image_gen/raw/main/assets/sample_photorealistic.png) |
| **Artistic (Van Gogh)** | Portrait of a robot | **Portrait of a robot, in the style of Van Gogh, thick impasto brushstrokes, swirling patterns, vibrant colors** | ![Artistic Van Gogh sample](https://github.com/ThangakumarC/Image_gen/raw/main/assets/sample_vangogh.png) |
